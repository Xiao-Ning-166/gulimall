...
import com.gulimall.admin.common.validator.Assert;
...
import com.gulimall.admin.modules.sys.form.PasswordForm;
import com.gulimall.admin.modules.sys.service.SysUserRoleService;
import com.gulimall.admin.modules.sys.service.SysUserService;
import com.gulimall.admin.modules.sys.vo.UserInfoVO;
...
public class SysUserController extends AbstractController {
	...
	public R info(){
		...
		BeanUtil.copyProperties(getUser(), userInfoVO);
		//获取用户所属的角色列表
		List<Long> roleIdList = sysUserRoleService.queryRoleIdList(userInfoVO.getUserId());
